...
public class joinGameActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        returnToGameLobbyButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent myIntent = new Intent(joinGameActivity2.this, GameLobbyActivity.class);
                joinGameActivity2.this.startActivity(myIntent);
            }
        });
        ...
        leaderboard.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view){
                Intent myIntent = new Intent(joinGameActivity2.this, LeaderboardActivity.class);
                ...
                if (requestCode == 1 && resultCode == RESULT_OK) ;
            {
                ...
                uploadTask.addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(joinGameActivity2.this, "ITEM SCAVENGED!", Toast.LENGTH_LONG).show();
                        ...
                        query.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                if (dataSnapshot.getChildrenCount() > 0) {
                                    ...
                                    nodeDataSnapshot.getRef().child("teamList").child("3").child("teamScavengeList").child("0").child("found").setValue(true);
                        ...
                        query.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                if (dataSnapshot.getChildrenCount() > 0) {
                                    ...
                                    String path = "/" + dataSnapshot.getKey() + "/" + key;
                                    HashMap<String, Object> result = new HashMap<>();
                                    nodeDataSnapshot.getRef().child("teamList").child("3").child("teamScavengeList").child("1").child("found").setValue(true);
                                    myRef.child(path).updateChildren(result);
                                }
                            }
                        ...
                        query.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                if (dataSnapshot.getChildrenCount() > 0) {
                                    ...
                                    String path = "/" + dataSnapshot.getKey() + "/" + key;
                                    HashMap<String, Object> result = new HashMap<>();
                                    nodeDataSnapshot.getRef().child("teamList").child("3").child("teamScavengeList").child("2").child("found").setValue(true);
                                    myRef.child(path).updateChildren(result);
                                }
                            }
                        ...
                        query.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                if (dataSnapshot.getChildrenCount() > 0) {
                                    ...
                                    String path = "/" + dataSnapshot.getKey() + "/" + key;
                                    HashMap<String, Object> result = new HashMap<>();
                                    nodeDataSnapshot.getRef().child("teamList").child("3").child("teamScavengeList").child("3").child("found").setValue(true);
                                    myRef.child(path).updateChildren(result);
                                }
                            }
                        ...
                        query.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                if (dataSnapshot.getChildrenCount() > 0)  {
                                    ...
                                    String path = "/" + dataSnapshot.getKey() + "/" + key;
                                    HashMap<String, Object> result = new HashMap<>();
                                    nodeDataSnapshot.getRef().child("teamList").child("3").child("teamScavengeList").child("4").child("found").setValue(true);
                                    myRef.child(path).updateChildren(result);
                                }
                            }
